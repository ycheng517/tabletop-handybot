...
def get_or_create_assistant():
    ...
    return client.beta.assistants.create(
        ...
        instructions=("You are a robot arm mounted on a table. Write and run code to "
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            "object_classes": {
                                "type": "string",
                                "description": ("Object classes to detect, space ",
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            ...
                            "object": {
                                "type": "string",
                                "description": "target object to execute the action for."
                            }
                        },
                        "required": [
                            "action",
